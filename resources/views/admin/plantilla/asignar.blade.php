...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <h5><b>Nombre de la plantilla:</b> {{$plantilla->name}}</h5>
            <h5><b>Nombre corto de la plantilla:</b> {{$plantilla->shortname}}</h5>
        </div>
        @if ($cursos->count() != $plantilla->cursos->count())
            <div class="card-body">
                <form action="{{route('admin.plantillas.agregarcurso')}}" method="POST">
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary">Agregar Cursos</button>    
